...
if (__webpack_require__(8)) {
  ...
  var toIndex = __webpack_require__(73);
...
module.exports = {
  ...
  function (test, buggy, set) {
    try {
      set = __webpack_require__(14)(Function.call, __webpack_require__(16).f(Object.prototype, '__proto__').set, 2);
      set(test, []);
...
var weatherWind = document.getElementById("weather-wind");
...
function getWeather() {
  var units = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "&units=metric";

  var appKey = "f817cddb3ec2d6eaae7099c1bbdf4596";
  var url = "https://api.openweathermap.org/data/2.5/weather?q=";
  var enteredValue = searchTxt.value == "" ? "Lodz" : searchTxt.value;
  var quoteUrl = url + enteredValue + units + "&appid=" + appKey;
...
// @@match logic
__webpack_require__(51)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
  return [
...
// @@replace logic
__webpack_require__(51)('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
  return [
...
// @@split logic
__webpack_require__(51)('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
  var internalSplit;
...
// @@search logic
__webpack_require__(51)('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
  return [
...
$export($export.S + $export.F * !__webpack_require__(45)(function (iter) {
  Array.from(iter);
}), 'Array', {
...
$export($export.P, 'Array', { copyWithin: __webpack_require__(79) });
...
$export($export.S, 'Math', { fround: __webpack_require__(188) });
